...
'''
PROBLEM_MIN, PROBLEM_MAX = 1000, 10000000 # 10K -> 10M elements
...
NUM_THREADS = 10 
NUM_BLOCKS = 10 
# sample size for each GPU = 200,000
########################################################################
...
# WRITE TO CSV FILE
with open("random_configs_combos.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
print("Generated file: random_configs_combos.csv")