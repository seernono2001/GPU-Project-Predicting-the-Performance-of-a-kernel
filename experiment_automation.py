...
configs = []
with open(CONFIGURATION_FILE, newline="") as f:
    ...
    for row in reader:
        ...
        align = row["Alignment"]
        configs.append((ps, tpb, nb, align))

# AUTOMATION
for ps, tpb, nb, align in configs:
    print(f"Executing: {EXECUTABLE} {ps} {tpb} {nb} {OPERATION} ({align} alignment)")
    ...
    for _ in range(REPETITION):
        ...
        result = subprocess.run(f"{EXECUTABLE} {ps} {tpb} {nb} {OPERATION}",
