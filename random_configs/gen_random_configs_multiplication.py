...
'''
PROBLEM_MIN, PROBLEM_MAX = 100, 2048 # 10K -> 2048 elements
...
# WRITE TO CSV FILE
with open("random_configs_multiplication.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
print("Generated file: random_configs_multiplication.csv")


################# STATISTIC SUMMARY ######################
sys.stdout = open("stat_sum_multiplication.txt", "w")
